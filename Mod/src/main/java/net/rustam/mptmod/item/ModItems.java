...
import net.rustam.mptmod.MptMod;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> AMBER_SWORD = ITEMS.register("amber_sword",
            () -> new AmberSword(ModWeaponMaterials.AMBER, 5, -2.4F,
                    new Item.Properties().tab(ModCreativeModeTab.MPT_TAB)));
    ...
    public static final RegistryObject<Item> AMBER_HOE = ITEMS.register("amber_hoe",
            () -> new Amberhoe(ModWeaponMaterials.AMBER, -2, -1.0F,
                    new Item.Properties().tab(ModCreativeModeTab.MPT_TAB)));
    public static final RegistryObject<Item> MULTITOOL = ITEMS.register("multi_tool",
            () -> new MultiToolItem(ModWeaponMaterials.AMBER,
